...
public static class BotologyCatalog
{
    ...
    {
        new PluginCatalogEntry("lootgoblin", "DOW/DOM Content Bots", "LootGoblin", ["LootGoblin"], "AutoDuty will do weird things including leaving duties early, even when not activated intentionally, and in a duty that AutoDuty does not even manage normally. This is volatile behaviour.", RedIds: ["autoduty"], IsAiAttributed: true),
        new PluginCatalogEntry("mogtome", "DOW/DOM Content Bots", "MOGTOME", ["MOGTOME"], "AutoDuty will do weird things including leaving duties early, even when not activated intentionally, and in a duty that AutoDuty does not even manage normally. This is volatile behaviour.", RedIds: ["autoduty"], IsAiAttributed: true),
        ...
        new PluginCatalogEntry("artisan", "DOH/L Content Bots", "Artisan", ["Artisan"], "There is no reason to uninstall this plugin unless you want to save space on your HD. Its operations are clean and non-interfering with the rest of the game.", IsAiAttributed: true),
        ...
        new PluginCatalogEntry("ai_duty_solver", "Duty solving", "AI Duty Solver", ["AIDutySolver", "AI Duty Solver"], "There is no reason to uninstall this plugin unless you want to save space on your HD. Its operations are clean and non-interfering with the rest of the game.", IsAiAttributed: true),
        ...
        new PluginCatalogEntry("frenrider", "Utility Bots", "FrenRider", ["FrenRider"], "AutoDuty will do weird things including leaving duties early, even when not activated intentionally, and in a duty that AutoDuty does not even manage normally. This is volatile behaviour.", RedIds: ["autoduty"], IsAiAttributed: true),
        ...
        new PluginCatalogEntry("vermaxion", "Utility Bots", "VerMaxion", ["VERMAXION", "VerMaxion"], "There is no reason to uninstall this plugin unless you want to save space on your HD. Its operations are clean and non-interfering with the rest of the game.", IsAiAttributed: true),
        ...
        new PluginCatalogEntry("xa_slave", "Utility Bots", "XA Slave", ["XASlave", "XA Slave"], "There is no reason to uninstall this plugin unless you want to save space on your HD. Its operations are clean and non-interfering with the rest of the game.", IsAiAttributed: true),
        ...
        new PluginCatalogEntry("questionable_wiggly", "Quest", "Questionable (wiggly)", ["Questionable", "QuestionableWiggly"], "These plugins have diverged already.", RedIds: ["questionable_punish"], IsAiAttributed: true),
